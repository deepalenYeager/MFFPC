import sys;sys.path.append('/home/xiaoxu/text_detection/MFFPC')
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, dcn=None):
        ...
        if not self.with_dcn or fallback_on_stride:
            ...
            if not self.with_modulated_dcn:
                from models.backbone.assets.dcn import DeformConv
                conv_op = DeformConv
                offset_channels = 18
            else:
                from models.backbone.assets.dcn import ModulatedDeformConv
...
def deformable_resnet34(pretrained=True, **kwargs):
